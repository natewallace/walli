...
namespace Wallace.IDE.SalesForce.Framework
{
  ...
  public class diff_match_patch {
    ...
    /**
     * Find the differences between two texts by line.
     ...
     */
    public List<Diff> diff_main_line(string text1, string text2)
    {
        Object[] a = diff_linesToChars(text1, text2);
        List<Diff> diffs = diff_main(a[0] as string, a[1] as string, false);
        diff_charsToLines(diffs, a[2] as List<string>);
